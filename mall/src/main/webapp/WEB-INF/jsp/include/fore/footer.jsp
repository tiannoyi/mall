...
<div id="footer"  class="footer" style="display: block;">
	...
	<div id="footer_ensure" class="footer_ensure">
		<a href="#nowhere">
			<img src="img/yjimg/QualityAssurance.PNG" style="width: 20%;height: 20%"/>
		</a>
		<a href="#nowhere">
			<img src="img/yjimg/7day.PNG" style="width: 20%;height: 20%"/>
		</a>
		<a href="specialService">
			<img src="img/yjimg/specialService.PNG" style="width: 20%;height: 20%"/>
		</a>
		<a href="helpcenter">
			<img src="img/yjimg/helpCenter.PNG" style="width: 20%;height: 20%"/>
		</a>
	</div>
