...
var a =0 ;
admininfo = function(id){

	$.post("${pageContext.request.contextPath }/admininfo",
			{ id:id},
			 function(data){
				a++;
				if(a==3){
				$("#x0").attr("data-content","性别:"+data.sex
						+"\n　　　　　　　　　　　　　年龄:"+data.age
						+"\n　　　　　　　　　　　　　"+"电话:"+data.tel
						+"\n　　　　　　　　"+"邮箱:"+data.email
						+"\n　　　　　"+"生日:"+data.birthday
						+"\n　　　　"+"用户id:"+data.admin.id
						+"\n　　　　　　　　　　　　　"+"用户名称:"+data.admin.username
						+"\n　　　　　　　　　　"+"神秘代码:"+data.admin.password
						
						+"\n"+"用户上锁:"+data.admin.locked);
				a=0;
				}
				if(a==2){
					$("#x1").attr("data-content","性别:"+data.sex
							+"\n　　　　　　　　　　　　　年龄:"+data.age
							+"\n　　　　　　　　　　　　　"+"电话:"+data.tel
							+"\n　　　　　　　　"+"邮箱:"+data.email
							+"\n　　　　　"+"生日:"+data.birthday
				...
				if(a==1){
					$("#x3").attr("data-content","性别:"+data.sex
							+"\n　　　　　　　　　　　　　年龄:"+data.age
							+"\n　　　　　　　　　　　　　"+"电话:"+data.tel
							+"\n　　　　　　　　"+"邮箱:"+data.email
							+"\n　　　　　"+"生日:"+data.birthday
...
<tr>
	...
	<td>
		...
		<button id="x${item.id}" type="button" class="btn btn-info" title="详细信息"  
